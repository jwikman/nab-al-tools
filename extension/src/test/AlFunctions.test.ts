...
suite("Classes.AL Functions Tests", function () {
    ...
    test("AL Codeunit procedure(param with parenthesis) Xliff", function () {
        const alObj = ALObject.getALObject(ALObjectTestLibrary.getCodeunitWithFunctionsWithParenthesisParam(), true);
        if (!alObj) {
    ...
    test("AL Table Xliff", function () {
        ...
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Table 2328808854 - Field 1296262074 - Property 2879900210', 'Table MyTable - Field MyField - Property Caption');
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Table 2328808854 - Field 1296262074 - Method 2126772001 - NamedType 1978266064', 'Table MyTable - Field MyField - Method OnValidate - NamedType TestOnValidateErr');
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Table 2328808854 - Field 3945078064 - Property 2879900210', 'Table MyTable - Field MyField2 - Property Caption');
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Table 2328808854 - Field 2443090863 - Property 2879900210', 'Table MyTable - Field MyFieldOption - Property Caption');
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Table 2328808854 - Field 2443090863 - Property 62802879', 'Table MyTable - Field MyFieldOption - Property OptionCaption');
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Table 2328808854 - NamedType 12557645', 'Table MyTable - NamedType TestErr');
    });

    test("AL RoleCenterPage Xliff", function () {
        const alObj = ALObject.getALObject(ALObjectTestLibrary.getRoleCenterPage(), true);
        if (!alObj) {
            assert.fail('Could not find object');
        }
        const mlObjects = alObj.getAllMultiLanguageObjects({ onlyForTranslation: true });
        ...
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Page 1933621741 - Action 3661919152 - Property 2879900210', 'Page My Role Center - Action Jobs - Property Caption');
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Page 1933621741 - Action 2273701615 - Property 2879900210', 'Page My Role Center - Action Job List - Property Caption');
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Page 1933621741 - Action 844797923 - Property 2879900210', 'Page My Role Center - Action Job Tasks - Property Caption');
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Page 1933621741 - Action 369017905 - Property 2879900210', 'Page My Role Center - Action Job Print Layouts - Property Caption');
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Page 1933621741 - Action 3504687331 - Property 2879900210', 'Page My Role Center - Action Resources - Property Caption');
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Page 1933621741 - Action 4265073908 - Property 2879900210', 'Page My Role Center - Action Resource List - Property Caption');
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Page 1933621741 - Action 3512836922 - Property 2879900210', 'Page My Role Center - Action Resource Capacity - Property Caption');
    });


    test("AL CueGroup page Xliff", function () {
        const alObj = ALObject.getALObject(ALObjectTestLibrary.getCueGroupPage(), true);
        if (!alObj) {
            assert.fail('Could not find object');
        }
        const mlObjects = alObj.getAllMultiLanguageObjects({ onlyForTranslation: true });
        ...
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Page 1018816708 - Control 3616567109 - Property 1295455071', 'Page My Cue Part - Control Field1 - Property ToolTip');
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Page 1018816708 - Control 2978870492 - Property 1295455071', 'Page My Cue Part - Control Field2 - Property ToolTip');
        assert.equal(getNextObject(i, mlObjects).xliffId(), 'Page 1018816708 - Control 2978870492 - Property 2879900210', 'Page My Cue Part - Control Field2 - Property Caption');

    });

    test("AL Page Xliff", function () {
        const alObj = ALObject.getALObject(ALObjectTestLibrary.getPage(), true);
        if (!alObj) {
            assert.fail('Could not find object');
        }
        const mlObjects = alObj.getAllMultiLanguageObjects({ onlyForTranslation: true });
    ...
    test("AL Codeunit Xliff", function () {
        const alObj = ALObject.getALObject(ALObjectTestLibrary.getCodeunit(), true);
        if (!alObj) {
            assert.fail('Could not find object');
        }
        const mlObjects = alObj.getAllMultiLanguageObjects({ onlyForTranslation: true });
    ...
    test("AL Query Xliff", function () {
        const alObj = ALObject.getALObject(ALObjectTestLibrary.getQuery(), true);
        if (!alObj) {
            assert.fail('Could not find object');
        }
        const mlObjects = alObj.getAllMultiLanguageObjects({ onlyForTranslation: true });
    ...
    test("AL TableExt Xliff", function () {
        const alObj = ALObject.getALObject(ALObjectTestLibrary.getTableExt(), true);
        if (!alObj) {
            assert.fail('Could not find object');
        }
        const mlObjects = alObj.getAllMultiLanguageObjects({ onlyForTranslation: true });
    ...
    test("AL PageExt Xliff", function () {
        const alObj = ALObject.getALObject(ALObjectTestLibrary.getPageExt(), true);
        if (!alObj) {
            assert.fail('Could not find object');
        }
        const mlObjects = alObj.getAllMultiLanguageObjects({ onlyForTranslation: true });
    ...
    test("AL Enum Xliff", function () {
        const alObj = ALObject.getALObject(ALObjectTestLibrary.getEnum(), true);
        if (!alObj) {
            assert.fail('Could not find object');
        }
        const mlObjects = alObj.getAllMultiLanguageObjects({ onlyForTranslation: true });
