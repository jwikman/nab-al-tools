...
suite("Levenshtein Functions Tests", function () {
  test("Levenshtein Ratio - Same", function () {
    const ratio: Levenshtein.Levenshtein = Levenshtein.getLevenshteinRatioAndDistance(
      "NAB AL Tools",
      "NAB AL Tools",
      Levenshtein.LevenshteinCost.ratio
    );
    assert.equal(ratio.ratio, 1);
  });

  test("Levenshtein Distance - Same", function () {
    const distance: Levenshtein.Levenshtein = Levenshtein.getLevenshteinRatioAndDistance(
      "NAB AL Tools",
      "NAB AL Tools",
      Levenshtein.LevenshteinCost.distance
    );
  ...
  test("MatchStringAgainstListOfStrings - Match All", function () {
    ...
    const result: Levenshtein.Levenshtein[] = Levenshtein.matchStringAgainstListOfStrings(
      "NAB AL Tools",
      targets,
      0
    );
