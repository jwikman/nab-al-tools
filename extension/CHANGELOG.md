...
- Fixed:
  ...
  - Support for Fields in a Request Page in XmlPorts was not supported, this is now fixed. Big thanks to [@ngiessel](https://github.com/ngiessel) for reporting this in [issue 187](https://github.com/jwikman/nab-al-tools/issues/187).
