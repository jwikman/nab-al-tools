...
- New features:
  ...
  - When running `NAB: Generate External Documentation` and parameters on a procedure page is of a object data type that is a public object in the current app, a link is added that points to that object.
- Fixes:
