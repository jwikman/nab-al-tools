...
- Changed:
  - **Updated minimum Node.js requirement**: The minimum required Node.js version has been updated from 20.0.0 to 22.0.0. This applies to both the VS Code extension and the MCP server (`@nabsolutions/nab-al-tools-mcp`). Node.js 22 is the current LTS (Long Term Support) version and provides performance improvements and modern JavaScript features. Users with Node.js 20.x or 21.x will need to upgrade to Node.js 22 or later.
- Fixes:
