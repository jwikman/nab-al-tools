...
- New Features:
  - Some additions has been done to `NAB: Generate External Documentation`:
    ...
    - New settings:
      - `NAB.documentation.api.IncludeDataType`: When creating external documentation, this setting specifies if the data types of fields on API pages should be included.
