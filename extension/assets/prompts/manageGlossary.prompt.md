...
- **Create new glossary**: "Create a new glossary file with English and Swedish"
- **Add language**: "Add Danish to the glossary" or "Add da-DK column to glossary"
- **Review glossary**: "Review the glossary for consistency" or "Check for missing translations in glossary"
- **Validate structure**: "Validate the glossary file structure"

The agent will guide you through the appropriate workflow for each operation.
