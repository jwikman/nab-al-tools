...
- `NAB.SearchReplaceBeforeSaveXliff`: Specifies if one or more Regular Expression Search & Replace should be performed on the XLF file before it is being saved to disk. Eg. this would affect the result after the \"NAB: Refresh XLF files from g.xlf\" has been executed.
